...
void EncoderMediaSubsession::SetVideoParameters(int width, int height, int bitrate, int framerate, int keyinterval, char *type)
{
	fWidth = width;
	fHeight = height;
...
void EncoderMediaSubsession::deleteStream(unsigned clientSessionId,
	...
	Debug(ckite_log_message, "deleteStream entry \n");
